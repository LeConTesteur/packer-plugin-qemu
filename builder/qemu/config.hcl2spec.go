...
type FlatConfig struct {
	...
	ArchiveContainingManyFiles *bool             `mapstructure:"many_files" required:"false" cty:"many_files" hcl:"many_files"`
	...
	DisksOrder                 []string          `mapstructure:"disks_order" required:"false" cty:"disks_order" hcl:"disks_order"`
...
func (*FlatConfig) HCL2Spec() map[string]hcldec.Spec {
	s := map[string]hcldec.Spec{
		...
		"many_files":                   &hcldec.AttrSpec{Name: "many_files", Type: cty.Bool, Required: false},
		...
		"disks_order":                  &hcldec.AttrSpec{Name: "disks_order", Type: cty.List(cty.String), Required: false},
