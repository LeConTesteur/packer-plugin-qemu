...
- `many_files` (bool) - Specify if the file containing many files to extract
...
- `disks_order` ([]string) - When `iso_url` is a archive containing many disks, `disks_order` specifies
